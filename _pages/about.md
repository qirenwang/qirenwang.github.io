...
## Research
My current research interests include **Autonomous Driving, Physical Intelligence, Machine Learning, Vision-Language Models (VLMs), Vision-Language-Action Models (VLAs), Large Language Models (LLMs), and Federated Learning**.
